 ...
 * @version    $Id: PasswordController.php 4 2009-6-1 Jaimie $
 */
class Account_PasswordController extends Zend_Controller_Action
{
    ...
    {
        $form = self::$accountForm->passwordForm();
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!$form->isValid($_POST)) {
                ...
                self::$accountDb->updateAccount($data,self::$auth->getIdentity()->account_id);

                $this->_redirect('/account/password/complete');
            }
        } else {
            $this->view->form = $form;
        }           
