 ...
 * @version    $Id: MoreController.php 4 2009-6-1 Jaimie $
 */
class Artist_MoreController extends Zend_Controller_Action
{
    /* @access Public
     * @var object
     */
    ...
    public function indexAction()
    {
        ...
        $breadcrumbs[] = array('title' => $this->view->translate('Menu_More'), 'url' => urlencode($artist['artist']));

        $this->view->placeholder('breadcrumbs')->exchangeArray( Helper_Breadcrumb::process($breadcrumbs) );
    

        // Meta information
        $this->view->headTitle($artist['artist'] . ' - ' . $this->view->translate('Text_Artist_More'));
