 ...
 * @version    $Id: EmailController.php 4 2009-6-1 Jaimie $
 */
class Account_EmailController extends Zend_Controller_Action
{
    ...
    {
        $form = self::$accountForm->emailForm();
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!$form->isValid($_POST)) {
                ...
                $values = $form->getValues();
                 ...
                 self::$accountDb->updateAccount($values);

                 $this->_redirect('/account/email/complete');
            }
        } else {
            $this->view->form = $form;
        }
