...
class Helper_Decorator_Composite extends Zend_Form_Decorator_Abstract
{
    public function buildLabel()
    {
        ...
        $label .= ':';
        return '<strong>'.$element->getView()
                       ->formLabel($element->getName(), $label, array('escape' => false)).'</strong> ';
    }
