 ...
 */
class Artist_IndexController extends Zend_Controller_Action
{
    /* @access Public
     * @var object
     */
    ...
    {        
        ...
        if(!self::$acl->isAllowed($accountType, null, 'view') ? "1" : "0") {
            $this->_redirect('error/access-denied/from/artist:index/action/view');
        }
        ...
        $letter_box='<a href="/artist/All">All&nbsp;&nbsp;&nbsp;</a>';
        ...
        for ( $letter=1; $letter<=26; $letter++ ) {         
            ...
            $letter_box .=  '<a href="artist/'.$inside.'">'.$inside.'</a>&nbsp;&nbsp;&nbsp;';
        }
        $this->view->letterSearch = $letter_box;

        $artistArray = self::$artistDb->getAllArtists($page, $alpha);        
